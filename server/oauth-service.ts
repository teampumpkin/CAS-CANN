...
export class OAuthService {
  ...
  getAuthorizationUrl(provider: string, redirectUri: string): string {
    if (provider === 'zoho_crm') {
      ...
      const params = [
        `scope=${encodeURIComponent('ZohoCRM.modules.ALL,ZohoCRM.settings.fields.ALL,ZohoCRM.settings.layouts.READ,ZohoCRM.settings.profiles.READ,ZohoCRM.send_mail.all.CREATE')}`,
