...
export default function CANNResources() {
  ...
  const formatEventDate = (dateString: string): string => {
    ...
    const dateForFormatting = new Date(Date.UTC(year, month - 1, day, 17, 0, 0)); // 17:00 UTC = noon EST
  ...
  const allCANNEvents = [
    {
      ...
      rawDate: "2026-02-18", // February 18, 2026 EST
    ...
    {
      id: 7,
      title: t('cannResources.events.quarterlySep2025.title'),
      date: t('cannResources.events.quarterlySep2025.date'),
      rawDate: "2025-09-16",
      time: t('cannResources.events.quarterlySep2025.time'),
      location: t('cannResources.events.quarterly.location'),
      format: t('cannResources.events.quarterly.format'),
      description: t('cannResources.events.quarterlySep2025.description'),
      registrationDeadline: t('cannResources.events.noRegistration'),
    ...
    {
      id: 6,
      title: t('cannResources.events.eduSeriesJun2026.title'),
      date: t('cannResources.events.eduSeriesJun2026.date'),
      rawDate: "2026-06-09",
      time: t('cannResources.events.eduSeriesJun2026.time'),
      location: t('cannResources.events.eduSeries.location'),
      format: t('cannResources.events.eduSeries.format'),
      description: t('cannResources.events.eduSeries.description'),
      topic: undefined as string | undefined,
      presentationTitle: t('cannResources.events.eduSeriesJun2026.presentationTitle'),
      speaker: t('cannResources.events.eduSeriesJun2026.speaker'),
      registrationDeadline: t('cannResources.events.noRegistration'),
      cmeCredits: t('cannResources.events.eduSeries.credits'),
      type: t('cannResources.events.types.webinar'),
    },
    {
      id: 9,
      title: t('cannResources.events.eduSeriesOct2026.title'),
      date: t('cannResources.events.eduSeriesOct2026.date'),
      rawDate: "2026-10-08",
      time: t('cannResources.events.eduSeriesOct2026.time'),
      location: t('cannResources.events.eduSeries.location'),
      format: t('cannResources.events.eduSeries.format'),
      description: t('cannResources.events.eduSeries.description'),
      topic: undefined as string | undefined,
      presentationTitle: t('cannResources.events.eduSeriesOct2026.presentationTitle'),
      speaker: t('cannResources.events.eduSeriesOct2026.speaker'),
      registrationDeadline: t('cannResources.events.noRegistration'),
      cmeCredits: t('cannResources.events.eduSeries.credits'),
      type: t('cannResources.events.types.webinar'),
    },
    {
      ...
      registrationDeadline: t('cannResources.events.summit.registration'),
