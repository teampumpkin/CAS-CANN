        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/70 leading-relaxed max-w-3xl mx-auto mb-8">
              Become part of a community dedicated to supporting patients, advancing research, and raising awareness about amyloidosis. Together, we can make a difference.
            </p>
