...
import { Menu, X, Phone, ChevronDown, Accessibility, Type, Contrast, MousePointer, Eye, EyeOff, Keyboard, Volume2, Monitor, Sun, Moon, Minus, Plus, RotateCcw, Settings, BookOpen, Shield, Heart, FileText, Handshake, Globe, Users, UserPlus, Calendar, Stethoscope, Network, Info, UserCheck, Mail, ArrowRight } from 'lucide-react';
  ...
  const navItems = [
    ...
    { name: t('nav.events'), href: '/events' },
    {
      ...
      dropdownItems: [
        ...
        { name: 'Resources/Events', href: '/nursing-network#resources' },
