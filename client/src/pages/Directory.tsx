                ...
                {paginatedCenters.map((center, index) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2 pt-4 border-t border-gray-200 dark:border-gray-600">
                      ...
                      <button className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-white rounded-3xl text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300">
              ...
              {totalPages > 1 && (
                <div className="flex justify-center items-center gap-2 mt-12">
                  <button
                    ...
                    className="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-white rounded-3xl text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>
