...
export default function AboutCANN() {
  ...
  const networkData = {
    mission: {
      ...
      description: "The Canadian Amyloidosis Nursing Network (CANN) is founded by nurses, for nurses. This purpose driven professional network is dedicated to supporting amyloidosis nurses and advancing nursing care for amyloidosis patients across Canada.",
      keyPoints: [
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
          ...
          >
            <div className="text-center">
              ...
              <div className="inline-flex items-center gap-3 bg-pink-500/10 dark:bg-pink-400/10 backdrop-blur-xl rounded-full px-6 py-3 border border-pink-500/20 dark:border-pink-400/20 mb-6">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-white/90">About Our Network</span>
              </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-white/70 leading-relaxed max-w-3xl mx-auto">
                Join a network dedicated to advancing amyloidosis nursing care across Canada.
              </p>
            </motion.div>
      ...
      <section id="join-section" className="py-24 bg-white dark:bg-gray-900 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-900/5 dark:via-white/5 to-transparent" />
        <div className="container mx-auto px-6 relative z-10">
      ...
      <section id="login" className="py-24 bg-gray-50 dark:bg-gray-800 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-900/5 dark:via-white/5 to-transparent" />
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
