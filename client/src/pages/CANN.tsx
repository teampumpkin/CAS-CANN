    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      <section className="py-32 bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <Link href="/directory" className="inline-flex items-center gap-2 text-gray-600 dark:text-white/70 hover:text-gray-900 dark:hover:text-white transition-colors mb-8">
