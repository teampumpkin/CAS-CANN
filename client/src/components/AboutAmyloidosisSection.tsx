          ...
          <div className="relative grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="text-gray-900 dark:text-white font-extrabold text-xl mb-2">{t('about.stats.canadiansAffectedLabel')}</div>
