...
import { Activity, AlertTriangle, Search, Target, ArrowLeft, ChevronDown, ChevronUp } from 'lucide-react';
import { useState } from 'react';
import { Link } from 'wouter';
import ParallaxBackground from '../../components/ParallaxBackground';
import medicalResearchImg from '@assets/DSC02841_1750068895454.jpg';

export default function ALect2Amyloidosis() {
  ...
  const detailedInfo = {
    ...
    diagnosis: [
      ...
      "Genetic testing for LECT2 mutations",
    ...
    centers: [
      {
        ...
        specialty: "Rare amyloidosis disorders"
      },
      {
        name: "Ottawa Hospital Research Institute",
        location: "Ottawa, ON",
        type: "Research Center",
        specialty: "ALect2 amyloidosis research"
      },
      {
        name: "University of Calgary",
        location: "Calgary, AB",
        type: "Treatment Center",
        specialty: "Genetic amyloidosis clinic"
      },
      {
        name: "Research Study: ALect2 Natural History",
        location: "Multiple Centers",
        type: "Clinical Trial",
        specialty: "Disease progression study"
      }
    ]
  };
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-xl rounded-full px-6 py-3 border border-white/20 mb-6">
              <Activity className="w-5 h-5 text-[#00AFE6]" />
              <span className="text-sm font-medium text-white/90">ALect2 Amyloidosis</span>
            </div>
            ...
            <p className="text-xl text-white/70 leading-relaxed max-w-3xl mx-auto">
              ALect2 amyloidosis is a rare form caused by deposits of leukocyte chemotactic factor 2. It primarily affects the kidneys and liver and is more commonly seen in certain ethnic populations.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-6 text-white/70 leading-relaxed">
                  <p className="text-lg">
                    ALect2 amyloidosis is a recently discovered form of systemic amyloidosis. It's more prevalent in people of Hispanic/Latino descent and typically affects adults over 60 years of age.
                  </p>
                  
                  <p>
                    The condition is characterized by deposits of leukocyte chemotactic factor 2 protein, primarily in the kidneys and liver. It tends to have a more indolent course compared to other forms of amyloidosis.
                  </p>
                  
                  <p>
                    Research into ALect2 amyloidosis is ongoing, with studies focusing on understanding the disease mechanism and developing targeted therapies for this rare condition.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-[#00AFE6]/10 to-[#00DD89]/10 border border-[#00AFE6]/20 rounded-2xl p-6 mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-white/80">Hispanic/Latino</div>
                    </div>
                    <div>
                      <span className="text-[#00AFE6] font-medium">Primary Organs:</span>
                      <div className="text-white/80">Kidney & Liver</div>
                    </div>
                  </div>
                </div>
              </motion.div>
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/10">
                  <div className="aspect-[4/5] relative">
                    <img 
                      ...
                      alt="Medical research for ALect2 amyloidosis treatment"
                      ...
                      <div className="px-6 py-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div className="text-center">
                            ...
                            <div className="text-xs text-white/80">Of All Amyloidosis</div>
                          </div>
                          <div className="text-center">
                            <div className="text-2xl font-bold bg-gradient-to-r from-[#00DD89] to-[#00AFE6] bg-clip-text text-transparent">
                              60+
                            </div>
                            <div className="text-xs text-white/80">Typical Age Onset</div>
                          </div>
                        </div>
                      </div>
                    </motion.div>
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/70">
                Comprehensive information about ALect2 amyloidosis symptoms, diagnosis, treatment, and care options.
              </p>
            </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/70">Recognizing early warning signs of ALect2 amyloidosis</p>
                    </div>
                  </div>
