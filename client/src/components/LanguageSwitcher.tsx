...
export const LanguageSwitcher = () => {
  ...
  return (
    <div className="relative">
      <motion.div
        className="flex items-center gap-1 bg-gray-100 backdrop-blur-sm border border-gray-300 rounded-full px-3 py-2 cursor-pointer hover:bg-gray-200 transition-all duration-300 shadow-sm"
