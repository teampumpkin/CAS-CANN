...
const upcomingEvents = [
  {
    ...
    type: "Journal Club",
    description:
      "One-hour virtual session designed for CAS members to deepen clinical and scientific knowledge through collaborative case-based discussion. Topics: Is it really hATTR? and more.",
    registrationUrl: "#",
    confirmed: true,
  },
  {
  ...
  },
  {
    ...
    type: "Summit",
    description:
      "This annual educational conference is jointly hosted by the CAS and Transthyretin Amyloidosis Canada (TAC). The Summit unites both amyloidosis healthcare professionals and patients with accredited scientific sessions.",
    registrationUrl: "#",
    isComingSoon: true,
  },
];
...
const pastEvents = [
  {
    ...
    type: "Journal Club",
    description:
      "Topics covered: AL Amyloidosis by Dr. Janine Mazengarb and Diagnostic Dilemmas by Dr. Rajin Choudhury.",
  },
  {
    id: 11,
    ...
    type: "Journal Club",
    description:
      "Topics covered: ATTR Neuropathy by Dr. Genevieve Matte and Cardiac Amyloidosis by Dr. Edgar Da Silva.",
  },
  {
    id: 12,
    ...
    type: "Summit",
    description:
      "The 2025 Canadian Amyloidosis Summit brought together healthcare professionals and patients for accredited scientific sessions and dedicated patient/caregiver sessions.",
  },
  {
    id: 13,
            ...
            >
              <div className="relative bg-gradient-to-br from-[#00AFE6]/15 to-[#00DD89]/15 dark:from-[#00AFE6]/25 dark:to-[#00DD89]/25 backdrop-blur-xl rounded-3xl p-8 border border-[#00AFE6]/30 shadow-2xl max-w-4xl w-full">
                <img
                  ...
                  alt="Save the Date - Canadian Amyloidosis Summit"
              ...
              <div className="bg-gradient-to-br from-white/90 to-gray-50/90 dark:from-gray-800/95 dark:to-gray-900/95 backdrop-blur-xl rounded-3xl p-10 border border-gray-200/50 dark:border-white/20 shadow-2xl max-w-2xl w-full">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 dark:text-white/70 mb-10 leading-relaxed text-lg">
                    The 2026 Canadian Amyloidosis Summit will be hosted by CAS
                    and Transthyretin Amyloidosis Canada (TAC). Stay tuned for
                  ...
                  <div className="space-y-4">
                    <Button
                      disabled
                      className="bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 border-0 cursor-not-allowed px-8 py-4 text-lg font-semibold rounded-2xl"
                    >
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-600 dark:text-white/70 max-w-3xl mx-auto leading-relaxed px-4">
              Join us at upcoming events and see highlights from our past
                  ...
                  >
                    <Card className="bg-gradient-to-br from-white/95 to-gray-50/95 dark:from-gray-800/95 dark:to-gray-900/95 backdrop-blur-xl border border-gray-200/60 dark:border-white/20 hover:border-[#00AFE6]/50 dark:hover:border-[#00AFE6]/60 hover:shadow-2xl hover:shadow-[#00AFE6]/15 transition-all duration-500 h-full flex flex-col rounded-3xl overflow-hidden">
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        {event.type !== "Journal Club" && !event.isComingSoon && (
                          <Button
                            onClick={() =>
                        ...
                        {event.isComingSoon && (
                          <Button
                            disabled
                            className="w-full bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 border-0 cursor-not-allowed py-3 rounded-2xl font-semibold text-sm"
                          >
                            Coming Soon
                          </Button>
                        )}
